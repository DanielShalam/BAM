...
from contrastive_croping.contrastive_croping_vit import update_box as update_box_vit
...
@torch.no_grad()
def update_box(arch, eval_train_loader, model, len_ds, block_idx, t=0.1):
    assert 'vit' in arch
    return update_box_vit(arch, eval_train_loader, model, len_ds, block_idx, t)
